...
# This script installs puppet 4.x and deploy the manifest using puppet apply -e "include beng_fw"
# Usage:
# <powershell>
# Set-ExecutionPolicy Unrestricted -Force
# icm $executioncontext.InvokeCommand.NewScriptBlock((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/relybv/dirict-beng_fw/master/files/bootme.ps1')) -ArgumentList ("beng_fw")
#</powershell>
  ...
  if(!(Test-Path -Path "C:\ProgramData\PuppetLabs\code\modules\beng_fw" )){
    $clone_args = @("clone",$puppet_source,"C:\ProgramData\PuppetLabs\code\modules\beng_fw" )
  } else {
    $clone_args = @("pull")
    Set-Location -Path "C:\ProgramData\PuppetLabs\code\modules\beng_fw"
  }
